  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.fenlei"
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="风格" prop="fengge">
          <el-select v-model="ruleForm.fengge" placeholder="请选择风格">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="风格" prop="fengge">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhekoujiaju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhekoujiajuCrossAddOrUpdateFlag = false;
                  this.parent.search();
